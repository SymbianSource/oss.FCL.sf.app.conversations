...
class CVIMPSTStorageManagerFactory : public CBase
    ...
    public: // New functions
         ...
         */
         IMPORT_C static void InitialiseLibraryL();
         
        /**
         * Release the resources allocated 
         */
         IMPORT_C static TInt Release();
         ...
         */         
         IMPORT_C static void InitialiseViewL( TUint32 aServiceId,
										const TDesC& aStoreName,
										const TDesC& aServiceName) ;
         
        /**
         * Returns the pointer to MVIMPSTStorageServiceView
         ...
         */
         IMPORT_C static  MVIMPSTStorageServiceView* ContactListInterfaceL(TUint32 aServiceId);
         ...
         */
         IMPORT_C static MVIMPSTStorageItemModel* ItemModelInterfaceL( TUint32 aServiceId ) ;
